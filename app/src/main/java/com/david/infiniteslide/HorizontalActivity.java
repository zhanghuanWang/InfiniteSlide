...
public class HorizontalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        infiniteSlideView1.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        infiniteSlideView2 = (InfiniteSlideView) findViewById(R.id.slide_view2);
        infiniteSlideView2.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        initdata();
    }
    ...
    private void initdata() {
        ...
        infiniteSlideView1.setSlideViewListener(new SlideViewListener() {
            ...
            public void onChange(View v, float offset, boolean left) {
                ...
                textView.setText(textView.getText().subSequence(0, 9) + "\n" + Float.toString(offset));
            }
        });
        ...
        infiniteSlideView2.setSlideViewListener(new SlideViewListener() {
            @Override
            public void onChange(View v, float offset, boolean left) {
                v.setRotation(left ? -offset * 720 : offset * 720);
...
//                textView.setText(textView.getText().subSequence(0, 9) + "\n" + Float.toString(offset));
    ...
    class MyAdapter extends RecyclerView.Adapter<MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new MyViewHolder(LayoutInflater.from(HorizontalActivity.this).inflate(R.layout.item, parent, false));
        }
